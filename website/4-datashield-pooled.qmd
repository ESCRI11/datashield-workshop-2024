...
2. On the `dsClient` package create a function named `ds.mean` that calls the `meanDS` function, recieves the results, and then combines them in order to output a pooled mean.
